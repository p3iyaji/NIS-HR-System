        ...
        <div class="col-sm-12">
            <div class="panel panel-bd lobidrag">
                ...
                <div class="panel-body p-l-30">
                    <form action="{{ route('employees.update', $employee->id) }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <fieldset>
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{ $employee->last_name }}" maxlength="400" >
                                        @error('last_name')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ $employee->first_name }}" maxlength="400" >
                                        @error('first_name')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="other_names" name="other_names" placeholder="Other Names" value="{{ $employee->other_names }}" maxlength="400">
                                        @error('other_names')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" placeholder="date_of_birth" value="{{ $employee->date_of_birth }}" >
                                        @error('date_of_birth')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control"
                                            ...
                                            @foreach($genders as $gender)
                                                <option @if($employee->gender_id==$gender->id) selected @endif
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control" name="nationality_id" id="nationality_id" >
                                                ...
                                                @foreach($nationalities as $nationality)
                                                    <option @if($employee->nationality_id==$nationality->id) selected @endif
                            ...
                            <div class="row gx-3">
                                    ...
                                    <div class="col-sm-12">
                                        <select  id="geo_state_id" name="geo_state_id" class="form-control" >
                                            ...
                                            @foreach ($states as $data)
                                                <option value="{{ $data->id }}" @if($employee->geo_state_id==$data->id) selected @endif
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="+234-8124638776" value="{{ $employee->contact_number }}" maxlength="100" >
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="height" name="height" placeholder="Height" value="{{ $employee->height }}" >
                                        @error('height')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="blood_group" name="blood_group" placeholder="Blood Group" value="{{ $employee->blood_group }}" >
                                        @error('blood_group')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="genotype" name="genotype" placeholder="genotype" value="{{ $employee->genotype }}" >
                                        @error('genotype')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="file" class="form-control" id="photograph" name="photograph" value="{{ $employee->photograph }}">
                                        @error('photograph')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" id="maritalstatus_id"
                                            ...
                                            @foreach($mstatuses as $status)
                                                <option @if($employee->maritalstatus_id==$status->id) selected @endif
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="zip_code" name="zip_code" placeholder="Zip Code" value="{{ $employee->zip_code }}" >
                                        @error('zip_code')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row gx-3">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea class="form-control" id="permanent_home_address" name="permanent_home_address" placeholder="Permanent Home Address" value="" maxlength="400" >
                                        {{ $employee->permanent_home_address }}
                                    </textarea>
                        ...
                        <fieldset>
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="service_number" name="service_number" placeholder="Service Number" value="{{ $employee->service_number }}" maxlength="400" >
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="rank_id" id="rank_id" >
                                            ...
                                            @foreach($ranks as $rank)
                                                <option @if($employee->rank_id==$rank->id) selected @endif
                                                value="{{ $rank->id }}">{{ $rank->rank }}</option>
                                            @endforeach
                                        </select>
                                        @error('rank_id')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="step" name="step" placeholder="Step" value="{{ $employee->step }}" maxlength="400" >
                                        @error('step')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="date" class="form-control" id="hire_date" name="hire_date" placeholder="Hire Date" value="{{ $employee->hire_date }}" maxlength="400" >
                                        @error('hire_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="designation_id" id="designation_id" >
                                            ...
                                            @foreach($designations as $designation)
                                                <option @if($employee->designation_id==$designation->id) selected @endif
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="command_id" id="command_id" >
                                            ...
                                            @foreach($commands as $command)
                                                <option @if($employee->command_id==$command->id) selected @endif
                                                value="{{ $command->id }}">{{ $command->command }}</option>
                                            @endforeach
                                        </select>
                                        @error('command_id')
                                        <div class="alert alert-danger"> {{ $message }}</div>
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="office_id" id="office_id" >
                                            ...
                                            @foreach($offices as $office)
                                                <option @if($employee->office_id==$office->id) selected @endif
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="division_id" id="division_id" >
                                            ...
                                            @foreach($divisions as $division)
                                                <option @if($employee->division_id==$division->id) selected @endif
                            ...
                            <div class="row gx-3">
                                    ...
                                    <div class="col-sm-12">
                                        <select class="form-control" name="unit_id" id="unit_id" >
                                            ...
                                            @foreach($units as $unit)
                                                <option @if($employee->unit_id==$unit->id) selected @endif
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="duty_post" name="duty_post" placeholder="Duty Post" value="{{ $employee->duty_post }}" maxlength="400" >
                                        @error('duty_post')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="nin" name="nin" placeholder="NIN" value="{{ $employee->nin }}" maxlength="400">
                                        @error('nin')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="passport_number" name="passport_number" placeholder="Passport Number" value="{{ $employee->passport_number }}" maxlength="400">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="date" class="form-control" id="exit_date" name="exit_date" placeholder="Exit Date" value="{{ $employee->exit_date }}" maxlength="400">
                                        @error('exit_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row gx-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="next_of_kin" name="next_of_kin" placeholder="Next of Kin" value="{{ $employee->next_of_kin }}" maxlength="400" >
                                        @error('next_of_kin')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="nok_number" name="nok_number" placeholder="+234-8124638776" value="{{ $employee->nok_number }}" maxlength="400" >
                                        @error('nok_number')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="nok_email" name="nok_email" placeholder="Next of Kin Email" value="{{ $employee->nok_email }}" maxlength="400" >
                                        @error('nok_email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="form-group">
                            <button type="submit" value="submit" class="btn btn-primary float-end">Save Changes</button>
                        </div>
